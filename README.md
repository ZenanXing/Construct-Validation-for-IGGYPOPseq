...
<img src="www/pipeline.png" style="display: block; margin-left: auto; margin-right: auto; height: 450px;" />  
...
<img src="www/best-clone-selection.png" style="display: block; margin-left: auto; margin-right: auto; height: 450px;" />  
...
| [Medaka](https://github.com/nanoporetech/medaka) | 2.0.1 |
...
| Assembly | Consensus Sequence | ./Assembly/racon/1rd/{{ alias }}_racon_1rd_f.fasta | Sequence generated after first round of Racon polishing. The sequences generated after second and third rounds of polishing are stored in the folders named `2rd` and `3rd`, respectively. | per-sample |
